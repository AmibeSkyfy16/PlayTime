 ...
 */
public class ElapsedTime2 implements Serializable {

    public Long timeElapsed;
    public byte[] dimension; // the value is this: player.world.getDimension().getEffects().getPath(); (the_nether, the_end, overworld)
    public byte[] biome;
    public boolean inWater;
    public boolean inLava;

    public ElapsedTime2(byte[] dimension, byte[] biome, boolean inWater, boolean inLava, Long timeElapsed) {
